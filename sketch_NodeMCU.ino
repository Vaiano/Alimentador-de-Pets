...
//---- WiFi settings
const char* ssid = "Home Wireless l";
const char* password = "pedrinho";

//---- MQTT Broker settings
const char* mqtt_server = "e68eeffb3c6c43bc844838b2bf2f7eca.s1.eu.hivemq.cloud"; // replace with your broker url
const char* mqtt_username = "pedro";
const char* mqtt_password = "pedro1234";
...
const char* sensor1_topic= "ServoMotor32020211";
...
void loop() {
  ...
  String pub = "Liberou ração";
  unsigned long now = millis();
    if(Serial.available()>0){
      char c=Serial.read();
      if(c=='G'){
        Serial.println(pub);   
        publishMessage(sensor2_topic,String(pub),true);
